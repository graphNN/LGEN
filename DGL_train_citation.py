# features augmentation for graph neural networks on citation networks

# graph augmentation neural networks
...
parser.add_argument('--model', type=str, default='GAT', help='GAT, GCN, GIN, APPNP, SAGE, SGC, TWIRLS')
...
#parser.add_argument('--features_predictor', type=bool, default=False)
